...
public class SwerveDrivetrain extends SubsystemBase {
	...
	public static final double REAR_RIGHT_VIRTUAL_OFFSET_RADIANS = .PI/2+Math.PI/16; // adjust as needed so that virtual (turn) position of wheel is zero when straight
